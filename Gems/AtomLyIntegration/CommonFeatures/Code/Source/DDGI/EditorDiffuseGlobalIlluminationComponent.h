    ...
    namespace Render
    {
        class EditorDiffuseGlobalIlluminationComponent final
            : public AzToolsFramework::Components::EditorComponentAdapter<
                  DiffuseGlobalIlluminationComponentController,
                  DiffuseGlobalIlluminationComponent,
        ...
        public:
            using BaseClass = AzToolsFramework::Components::EditorComponentAdapter<
                ...
                DiffuseGlobalIlluminationComponentConfig>;
            AZ_EDITOR_COMPONENT(
                AZ::Render::EditorDiffuseGlobalIlluminationComponent, EditorDiffuseGlobalIlluminationComponentTypeId, BaseClass);
