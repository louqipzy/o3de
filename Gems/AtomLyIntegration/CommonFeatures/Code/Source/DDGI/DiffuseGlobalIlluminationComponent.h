...
#include <DDGI/DiffuseGlobalIlluminationComponentConfig.h>
#include <DDGI/DiffuseGlobalIlluminationComponentConstants.h>
#include <DDGI/DiffuseGlobalIlluminationComponentController.h>
