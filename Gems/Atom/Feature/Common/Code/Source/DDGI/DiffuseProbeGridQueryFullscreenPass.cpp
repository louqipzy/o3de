...
#include <DDGI/DiffuseProbeGridQueryFullscreenPass.h>
#include <DDGI/DiffuseProbeGridQueryFullscreenPassData.h>
...
namespace AZ
{
    namespace Render
    {
        ...
        void DiffuseProbeGridQueryFullscreenPass::LoadShader()
        {
            ...
            static const char* QueryFullscreenShaderFilePath = "Shaders/DDGI/DiffuseProbeGridQueryFullscreen.azshader";
            static const char* QueryFullscreenWithAlbedoShaderFilePath = "Shaders/DDGI/DiffuseProbeGridQueryFullscreenWithAlbedo.azshader";
