...
namespace AZ
{
    namespace Render
    {
        ...
        void DiffuseProbeGridRayTracingPass::CreateRayTracingPipelineState()
        {
            ...
            AZStd::string shaderFilePath = "Shaders/DDGI/DiffuseProbeGridRayTracing.azshader";
            ...
            // closest hit shader
            AZStd::string closestHitShaderFilePath = "Shaders/DDGI/DiffuseProbeGridRayTracingClosestHit.azshader";
            ...
            // miss shader
            AZStd::string missShaderFilePath = "Shaders/DDGI/DiffuseProbeGridRayTracingMiss.azshader";
