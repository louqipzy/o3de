...
namespace AZ
{
    namespace Render
    {
        ...
        void DiffuseProbeGridVisualizationRayTracingPass::CreateRayTracingPipelineState()
        {
            ...
            AZStd::string shaderFilePath = "Shaders/DDGI/DiffuseProbeGridVisualizationRayTracing.azshader";
            ...
            // closest hit shader
            AZStd::string closestHitShaderFilePath = "Shaders/DDGI/DiffuseProbeGridVisualizationRayTracingClosestHit.azshader";
            ...
            // miss shader
            AZStd::string missShaderFilePath = "Shaders/DDGI/DiffuseProbeGridVisualizationRayTracingMiss.azshader";
