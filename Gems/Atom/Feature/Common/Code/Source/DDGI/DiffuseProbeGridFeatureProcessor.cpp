...
#include <Atom/Feature/DDGI/DiffuseProbeGrid_Traits_Platform.h>
...
namespace AZ
{
    namespace Render
    {
        ...
        void DiffuseProbeGridFeatureProcessor::Activate()
        {
            ...
            Data::Instance<RPI::Shader> shader = RPI::LoadCriticalShader("Shaders/DDGI/DiffuseProbeGridRender.azshader");
            if (shader)
            {
            ...
            m_sceneAndViewShader = RPI::LoadCriticalShader("Shaders/DDGI/SceneAndViewSrgs.azshader");
        ...
        void DiffuseProbeGridFeatureProcessor::AddRenderPasses(AZ::RPI::RenderPipeline* renderPipeline)
        {
            ...
            {
                AddPassRequest(renderPipeline, "Passes/DDGI/DiffuseProbeGridPreparePassRequest.azasset", "DepthPrePass");
                AddPassRequest(renderPipeline, "Passes/DDGI/DiffuseProbeGridUpdatePassRequest.azasset", "DiffuseProbeGridPreparePass");
                AddPassRequest(renderPipeline, "Passes/DDGI/DiffuseProbeGridRenderPassRequest.azasset", "ForwardSubsurface");

                // add the fullscreen query pass for SSR raytracing fallback color
                AddPassRequest(renderPipeline, "Passes/DDGI/DiffuseProbeGridScreenSpaceReflectionsQueryPassRequest.azasset", "ReflectionScreenSpaceRayTracingPass");
                ...
                if (auxGeomPass)
                {
                    AddPassRequest(renderPipeline, "Passes/DDGI/DiffuseProbeGridVisualizationPassRequest.azasset", "PostProcessPass");
                }
